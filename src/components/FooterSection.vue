    ...
    <div class="bg-white dark:bg-stone-950">
      <div class="container mx-auto px-6 py-8">
        ...
        <div class="my-4 flex justify-center">
          <h2 class="mx-4 text-sm text-gray-600 transition-colors duration-300 dark:text-gray-300">
            Horaires du garage
          </h2>
          <p class="mx-4 text-sm text-gray-600 transition-colors duration-300 dark:text-gray-300">
            ICI LE COMPONENT horaires
          </p>
        </div>
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-between">
          ...
          <div class="-mx-2 flex">
            <a
              ...
              target="_blank"
              class="mx-2 text-gray-600 transition-colors duration-300 hover:text-red-500 dark:text-gray-300 dark:hover:text-red-400"
              aria-label="Reddit"
            >
              <svg
            ...
            <a
              href="https://www.github.com/antikkorps"
              target="_blank"
              class="mx-2 text-gray-600 transition-colors duration-300 hover:text-red-500 dark:text-gray-300 dark:hover:text-red-400"
              aria-label="Github"
            >
