    ...
    <form class="w-full sm:w-1/3 justify-self-center">
      <div class="space-y-12">
        ...
        <div class="border-b border-gray-900/10 pb-12">
          ...
          <p class="mt-1 text-sm leading-6 text-gray-600">
            Afin de choisir si vous souhaitez que votre annonce s'affiche sur le site ou non.
          </p>
              ...
              <div class="mt-6 space-y-6">
                <div class="relative flex gap-x-3">
                  ...
                  <div class="text-sm leading-6">
                    <label for="comments" class="font-medium text-gray-900">Publier</label>
                ...
                <div class="relative flex gap-x-3">
                  ...
                  <div class="text-sm leading-6">
                    <label for="candidates" class="font-medium text-gray-900">Mise en avant</label>
                    <p class="text-gray-500">
