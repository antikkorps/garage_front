...
<template>
  ...
  >
    <div class="absolute top-0 left-0 transform -rotate-33 bg-yellow-400 p-4 rounded-md shadow-md">
      <p class="text-sm font-semibold text-gray-800">📢 Annonce à l'affiche</p>
    </div>
